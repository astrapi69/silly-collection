...
|:-:|
|<img width=100/> ![sonatype repository](https://avatars1.githubusercontent.com/u/33330803?s=200&v=4) <img width=500/>|
...
|**coveralls.io**|
|:-:|
|<img width=100/> ![Coverage Status](https://coveralls.io/repos/github/astrapi69/mystic-crypt/badge.svg) <img width=500/>|
|Many thanks to [coveralls.io](https://coveralls.io) for providing a free code coverage for open source projects|

|**javadoc.io**|
|:-:|
|<img width=100/>[![Javadocs](http://www.javadoc.io/badge/de.alpharogroup/silly-collections.svg)](http://www.javadoc.io/doc/de.alpharogroup/silly-collections)  <img width=500/>|
